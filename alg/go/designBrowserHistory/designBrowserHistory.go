...
func Constructor(homepage string) BrowserHistory {
	return BrowserHistory{websites: []string{homepage}}
}

func (b *BrowserHistory) Visit(url string) {
	b.websites = b.websites[:b.index+1]
	b.websites = append(b.websites, url)
	b.index = len(b.websites) - 1
}
